...
public class updateContriIndivvice extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (rowsUpdated > 0) {
                response.sendRedirect("individualContributionvice.jsp"); // Redirect to the list page or a success page
            } else {
