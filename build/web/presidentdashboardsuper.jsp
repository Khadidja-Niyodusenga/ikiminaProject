...
<body>
    <%
        ...
        if (session == null || !"admin".equalsIgnoreCase(position)) {
        ...
        <main class="main-content">
            ...
            <div class="dashboard-links">
                <div class="dashboard-link">
                    ...
                    <a href="ListRequestssuper.jsp">Approve New Membership</a>
                </div>
                
                <div class="dashboard-link">
                    <img src="withdraw-7012514-5747081.webp" alt="Withdraw">
                    <a href="listWithdrawsuper.jsp">Approve Withdraw Request</a>
                </div>
                
                <div class="dashboard-link">
                    <img src="loanst.jpg" alt="View Loan Status Report">
                    <a href="LoanLisPressuper.jsp">View Loan Status </a>
                </div>
                <div class="dashboard-link">
                    <img src="cont.jpg" alt="View Contribution Status Report">
                    <a href="ListContributionIndivsuper.jsp">View Contribution Status </a>
                </div>
            </div>
        </main>
    </div>
