...
<body>
    <div class="container">
        <aside class="sidebar">
            ...
            <nav>
                <a href="StaffDashboard.jsp"><img src="dashboard.jfif" alt="Dashboard">Dashboard</a>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-links">
                <div class="dashboard-link">
                    ...
                    <a href="listContributions.jsp">View Contributions</a>
                </div>
                <div class="dashboard-link">
                    <img src="loa.jpg" alt="Loan">
                    <a href="LoanLis.jsp">Manage Loans</a>
                </div>
                <div class="dashboard-link">
                    <img src="memb.jpg" alt="Member">
                    <a href="listMembers.jsp">Manage Members</a>
                </div>
                <div class="dashboard-link">
...
<!--                <div class="dashboard-link">
                ...
                <div class="dashboard-link">
                    ...
                    <a href="ListWith.jsp">Manage Withdrawals</a>
                </div>
            </div>
        </main>
    </div>
