...
<body>
    ...
    <form action="InsertLoan" method="post">
        Member ID: <input type="number" name="mid" required /><br/>
        Loan Amount: <input type="text" name="loan_amount" required /><br/>
        Interest: <input type="text" name="interest" required /><br/>
        Request Loan Date: <input type="date" name="request_loan_date" required /><br/>
        <br/>
        Reason for Loan: <textarea name="reason_for_loan" rows="4" required></textarea><br/>
        <br/>
        Payment Date: <input type="date" name="payment_date" /><br/>
                Guarantor Email: <input type="email" name="payment_date" /><br/>
                Remaining Loan: <input type="date" name="payment_date" /><br/>
