    ...
    <aside class="sidebar">
            ...
            <header>
                ...
                <div class="dashboard-link">
                    ...
                    <a href="ListContributionIndivPres.jsp">View Contributions</a>
                </div>
                <div class="dashboard-link">
                    <img src="loa.jpg" alt="Loan">
                    <a href="LoanLisIndivPres.jsp">View Loans</a>
                </div>
                <div class="dashboard-link">
                    <img src="memb.jpg" alt="Member">
                    <a href="listMembersIndivPres.jsp">Manage Members</a>
                </div>
                <div class="dashboard-link">
...
<!--                <div class="dashboard-link">
                ...
                <div class="dashboard-link">
                    ...
                    <a href="staff.html">View Staff</a>
                </div>
                <div class="dashboard-link">
                    <img src="withdraw-7012514-5747081.webp" alt="Withdraw">
                    <a href="ListWithIndividualPres.jsp">View Withdrawals</a>
                </div>
            </div>
        </main>
    </div>
