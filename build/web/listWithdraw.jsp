    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                     <a href="EditWithdraw.jsp?rwid=<%= rwid %>" class="button">Approve</a>
                    <a href="EditWithdraw.jsp?rwid=<%= rwid %>" class="button">Edit</a>
                    <a href="DeleteWithdraw?rwid=<%= rwid %>" class="button delete" onclick="return confirm('Are you sure you want to delete this withdraw request?');">Delete</a>
