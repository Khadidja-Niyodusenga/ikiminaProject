<%-- 
    ...
    Created on : Aug 24, 2024, 1:08:52 PM
    Author     : user
--%>
            ...
            <div id="super-admin-dashboard" class="page">
                ...
                <div class="dashboard-links">
                    <div class="dashboard-link">
                        ...
                        <a href="listContributions.jsp">Contribution</a>
                    </div>
                    <div class="dashboard-link">
                        <img src="loa.jpg" alt="Loan">
                        <a href="LoanList.jsp">Loan</a>
                    </div>
                    <div class="dashboard-link">
                        <img src="memb.jpg" alt="Member">
                        <a href="listMembers.jsp">Member</a>
                    </div>
                    <div class="dashboard-link">
                    ...
                    <div class="dashboard-link">
                        ...
                        <a href="ListRequests.jsp">Request Membership</a>
                    </div>
                   
                    <div class="dashboard-link">
                        <img src="withdraw-7012514-5747081.webp" alt="Withdraw">
                        <a href="listWithdraw.jsp">Withdraw</a>
                    </div>
                </div>
            </div>
        </main>
