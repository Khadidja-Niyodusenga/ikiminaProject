    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><%= approvedDate %></td>
                <td>
                    <a href="editMemberNormal.jsp?id=<%= mid %>" class="button">Edit</a>
                    <a href="deleteMemberNormal?id=<%= mid %>" class="button delete" onclick="return confirm('Are you sure you want to delete this member?');">Delete</a>
                </td>
            </tr>
            <%
                    }
