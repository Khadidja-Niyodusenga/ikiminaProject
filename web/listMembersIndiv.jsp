    ...
    <div class="container">
       <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="indivnormalstaff.html"><img src="normal.jfif" alt="Normal Staff">Normal Staff</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><%= approvedDate %></td>
                <td>
                    <a href="EditMember?id=<%= mid %>" class="button">Edit</a>
                    <a href="deleteMember?id=<%= mid %>" class="button delete" onclick="return confirm('Are you sure you want to delete this member?');">Delete</a>
                </td>
            </tr>
            <%
                    }
