    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="individualContribution.jsp"><img src="guestnew.jfif" alt="Guest">View Contribution</a><br/>
                <a href="individualwithdrawform.jsp"><img src="normal.jfif" alt="Normal Staff">Make Withdraw</a><br/>
                <a href="individualLoan.jsp"><img src="credit comi.png" alt="Credit Committee">View loan</a><br/>
        ...
        <main class="main-content">
            ...
            <h1>Request Loan</h1>
            <form action="insertLoanIndiv" method="post">
