...
<body>
    <%
        ...
        if (session == null || !"president".equalsIgnoreCase(position)) {
        ...
        <main class="main-content">
            ...
            <div class="dashboard-links">
                <div class="dashboard-link">
                    ...
                    <a href="ListRequestsPres.jsp">Approve New Membership</a>
                </div>
                
                <div class="dashboard-link">
                    <img src="withdraw-7012514-5747081.webp" alt="Withdraw">
                    <a href="listWithdrawpresident.jsp">Approve Withdraw Request</a>
                </div>
                <div class="dashboard-link">
                ...
                <div class="dashboard-link">
                    ...
                    <a href="LoanLisPresView.jsp">View Loan Status </a>
                </div>
                <div class="dashboard-link">
                    <img src="cont.jpg" alt="View Contribution Status Report">
                    <a href="ListContributionIndivPres.jsp">View Contribution Status </a>
                </div>
            </div>
        </main>
    </div>
