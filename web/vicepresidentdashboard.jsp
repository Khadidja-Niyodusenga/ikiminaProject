...
<body>
    <%
        ...
        if (session == null || !"vice president".equalsIgnoreCase(position)) {
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="creditDashboardvice.jsp"><img src="credit comi.png" alt="Credit Committee">Credit Committee</a><br>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-links">
                <div class="dashboard-link">
                    <img src="cont.jpg" alt="Approve New Membership">
                    <a href="ListRequestsvice.jsp">Approve New Membership</a>
                </div>
                
                <div class="dashboard-link">
                    <img src="withdraw-7012514-5747081.webp" alt="Withdraw">
                    <a href="listWithdrawvice.jsp">Approve Withdraw Request</a>
                </div>
                <div class="dashboard-link">
                    <img src="profit.jpg" alt="View Profit for the Entire Group">
                    <a href="#">View Profit for the Entire Group</a>
                </div>
                <div class="dashboard-link">
                    <img src="loanst.jpg" alt="View Loan Status Report">
                    <a href="LoanLisvii.jsp">View Loan Status </a>
                </div>
                <div class="dashboard-link">
                    <img src="cont.jpg" alt="View Contribution Status Report">
                    <a href="ListContributionvice.jsp">View Contribution Status </a>
                </div>
            </div>
        </main>
    </div>
