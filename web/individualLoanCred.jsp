    ...
    <div class="container">
       <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="individualContributionCred.jsp"><img src="guestnew.jfif" alt="Guest">Contribution</a>
                <a href="viewIndividualWithCred.jsp"><img src="normal.jfif" alt="Normal Staff"> Withdraw</a>
                <a href="individualLoanCred.jsp"><img src="credit comi.png" alt="Credit Committee">Loan</a>
        ...
        <main class="main-content">
            ...
            <h1>Loan List</h1>
            <a href="loanformindivCred.jsp" class="back-button">Request Loan</a>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <%
                        ...
                        try {
                            ...
                            String sql = "SELECT * FROM loan WHERE mid = ?";
                    ...
                    %>
                    <tr>
                        <td colspan="9">Error retrieving data: <%= e.getMessage() %></td>
                    </tr>
                    <%
                        } finally {
