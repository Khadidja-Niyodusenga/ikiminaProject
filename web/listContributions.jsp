    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><%= status %></td>
                <td>
                    <a href="EditContributionsuper.jsp?id=<%=contributionId %>" class="button">Edit</a>
                    <a href="DeleteContributionsuper?id=<%=contributionId %>" class="button delete" onclick="return confirm('Are you sure you want to delete this contribution?');">Delete</a>
                </td>
            </tr>
            <%
                    }
