    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><%= approvedDate %></td>
                <td>
                    <a href="editMembervice.jsp?id=<%= mid %>" class="button">Edit</a>
                    <a href="deleteMembervice?id=<%= mid %>" class="button delete" onclick="return confirm('Are you sure you want to delete this member?');">Delete</a>
                </td>
            </tr>
            <%
                    }
